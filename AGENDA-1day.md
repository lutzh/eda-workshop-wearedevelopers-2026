...
| Time | Topic |
|------|-------|
| 13:30 - 14:00 | **Event Design (part 2)** -- Designing for idempotency and ordering, event metadata and envelopes, message keys, serialization formats. |
| 14:00 - 14:45 | **Producer Responsibilities** -- Delivery guarantees, the dual write problem, the transactional outbox pattern, delivery ordering and partitioning. |
| 14:45 - 15:30 | **Consumer Responsibilities** -- Error handling and blocking retry, processing order guarantees, idempotency, exactly-once processing, the idempotent receiver pattern. |
...
| Time | Topic |
|------|-------|
| 15:30 - 16:15 | **Complex Workflows** -- Orchestration vs. choreography, the Saga pattern, decomposing workflows, the Unix philosophy for services, observability vs. control. *Group exercise.* |
| 16:15 - 17:00 | **Patterns & Failure Handling** -- Retry topics and dead letter queues, delayed reprocessing, Change Data Capture for the outbox, timeouts and time-triggered events. |
| 17:00 - 17:20 | **Schema Evolution** -- Non-breaking vs. breaking changes, compatibility modes, rolling out breaking changes, schema registries. |
| 17:20 - 17:40 | **Operations & Observability** -- Logs, metrics, and traces for EDA, distributed tracing, correlation and causation IDs, consumer lag, scaling. |
